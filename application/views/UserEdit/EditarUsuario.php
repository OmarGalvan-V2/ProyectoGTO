                    ...
                    <div class="col">
                        <div class="input-icon">
                            ...
                            <input type="text" class="form-control" name="Paterno" id="Paterno"
                                placeholder="Apellido Paterno" value="<?=$Empleado[0]['Paterno']?>">
                        </div>
                    </div>
                    <div class="col">
                        <div class="input-icon">
                            ...
                            <input type="text" class="form-control" name="Materno" id="Materno"
                                placeholder="Apellido Materno" value="<?=$Empleado[0]['Materno']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        <div class="input-icon">
                            ...
                            <input type="text" class="form-control" name="PuestoLaboral" id="PuestoLaboral"
                                placeholder="Puesto Laboral" value="<?=$Empleado[0]['PuestoLaboral']?>">
                        </div>
                    </div>
                    <div class="col">
                        <div class="input-icon">
                            ...
                            <select class="form-control" id="AreaLaboral" name='AreaLaboral'>
                                <!-- Aquí generas opciones para el select usando PHP -->
                                <?php for ($i = 0; $i < count($data); $i++) { ?>
                                <option value="<?= $data[$i]['ID'] ?>"><?= $data[$i]['AreaLaboral'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
